...
<body>
    ...
    <form action="../mchs_hcd_2017/" method="POST">
    	Username: 
		<br>
	...
	<form action="../mchs_hcd_2017/" method="POST"> <button name="back" value="back" class="button buttonBack" style="vertical-align:middle">Back</button></form>
</font>
</body>
</html>